        ...
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success' && res.data.data.user.role === 'user') {
              ...
              (0, _alert.showAlert)('success', 'Quản lý đăng nhập thành công!');
              window.setTimeout(function () {
...
exports.denyOrder = exports.denyManyOrder = exports.deleteOrder = exports.deleteManyOrder = exports.agreeOrder = exports.agreeManyOrder = void 0;
...
var agreeManyOrder = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(data) {
    var res;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) {
  ...
  return function agreeManyOrder(_x2) {
    return _ref2.apply(this, arguments);
  };
}();

exports.agreeManyOrder = agreeManyOrder;
...
var denyManyOrder = /*#__PURE__*/function () {
  ...
  return function denyManyOrder(_x4) {
    return _ref4.apply(this, arguments);
  };
}();

exports.denyManyOrder = denyManyOrder;

var deleteOrder = /*#__PURE__*/function () {
  var _ref5 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5(idOrder) {
    var res;
...
var deleteManyOrder = /*#__PURE__*/function () {
  ...
  return function deleteManyOrder(_x6) {
  ...
  btnOrderShows.forEach(function (btnOrderShow) {
    btnOrderShow.addEventListener("click", function (e) {
      ...
      if (arrayDateShow[1] < 10) {
        arrayDateShow[1] = "0".concat(arrayDateShow[1]);
      }
...
if (btnCheckAllOrder) {
  btnCheckAllOrder.addEventListener("click", function (e) {
    if (btnCheckAllOrder.checked) {
      ...
      _toConsumableArray(btnCheckOrders).forEach(function (el) {
        el.checked = false;
...
if (btnConfirmForMany) {
  btnConfirmForMany.addEventListener("click", function (e) {
    ...
    if (selectActionMany == 0) {
      ...
      (0, _udAdminOrder.denyManyOrder)(arrIdByCheckForSubmit);
    } else if (selectActionMany == 3) {
      (0, _udAdminOrder.deleteManyOrder)(arrIdByCheckForSubmit);
    }
  });
}
